...
\title{Web Assessment of Libyan Government E-government Services}


% author names and affiliations
% use a multiple column layout for up to three different
% affiliations
\author{\IEEEauthorblockN{Mohd Zamri Murah, Abdullah Ahmed Ali}
\IEEEauthorblockA{Center for Cybersecurity,\\
Universiti Kebangsaan Malaysia,\\
Malaysia\\
email: zamri@ukm.edu.my, abdullah.alhanash@gmail.com}}
...
\begin{abstract}
  ...
  e-government services. The e-government initiative involves the use of
  ...
  web security assessment of 16 Libyan government websites. The main
  purpose of this study is to determine the security level of these
  websites.  The web security assessment was done in four phases:
  ...
  vulnerabilities and to mitigate future cyber security attacks.
...
\begin{IEEEkeywords}
  Libya, E-government, Web Security Assessment, Information Security,
